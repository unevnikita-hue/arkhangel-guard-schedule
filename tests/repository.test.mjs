...
test('demo contains enough guards to test drag and drop',()=>{assert.ok(demoData.guards.length>=12);assert.ok(demoData.legalEntities[0].objects[0].posts.length);assert.ok(demoData.templates.length)});
